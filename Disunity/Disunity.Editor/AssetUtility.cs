...
namespace Disunity.Editor {
    ...
    public class AssetUtility {
        ...
        /// <summary>
        ///     Finds and returns the directory where Disunity is located.
        /// </summary>
        /// <returns>The directory where Disunity is located.</returns>
        public static string GetDisunityDirectory() {
            var location = typeof(ModInfo).Assembly.Location;

            var disunityDirectory = Path.GetDirectoryName(location);

            if (!Directory.Exists(disunityDirectory)) {
                disunityDirectory = Path.Combine(Directory.GetCurrentDirectory(), "Assets");
            }

            return GetRelativePath(disunityDirectory);
        }
        ...
        public static List<string> GetAssets(string filter) {
            ...
            foreach (var guid in assetGuids) {
                ...
                if (assetPath.Contains("Disunity") && !assetPath.Contains("ExportSettings")) {
                    continue;
                }
        ...
        /// <summary>
        ///     Create an asset for a ScriptableObject in a Disunity Resources directory.
        /// </summary>
