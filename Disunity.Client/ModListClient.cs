...
namespace Disunity.Client {
    ...
    public partial class ModListClient : IModListClient
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public ModListClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl; 
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<ModDto>> GetModsAsync(int? page, int? pageSize)
        {
            return GetModsAsync(page, pageSize, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Return a JSON array of all mods registered with disunity.io</returns>
        /// <exception cref="ApiClientException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.List<ModDto>> GetModsAsync(int? page, int? pageSize, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.List<ModDto>>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(System.Collections.Generic.List<ModDto>);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <exception cref="ApiClientException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.List<ModDto>> GetModsAsync(int targetId, int? page, int? pageSize)
        {
            return GetModsAsync(targetId, page, pageSize, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Return a JSON array of all found mods compatible with the given target id</returns>
        /// <exception cref="ApiClientException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.List<ModDto>> GetModsAsync(int targetId, int? page, int? pageSize, System.Threading.CancellationToken cancellationToken)
        {
            if (targetId == null)
